...
6. WRONG CHART REFERENCES: [CHART: name] references that don't match available charts
...
errors, fabricated numbers, missed DuPont/trend/peer analysis, or invalid chart refs.
"""
